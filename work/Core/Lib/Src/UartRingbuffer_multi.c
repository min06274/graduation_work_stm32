...
void GetDataFromBuffer (char *startString, char *endString, char *buffertocopyfrom, char *buffertocopyinto, int *buffertocopyintoweight)
{
...
repeat2:
	...
	for (int i=startposition; i<endposition; i++)
	{
		...
		*buffertocopyintoweight *= 10;
		*buffertocopyintoweight += buffertocopyinto[indx] - '0';
		indx++;
	}
}
